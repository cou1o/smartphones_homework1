...
import 'package:ab2/tambahdata.dart';
import 'package:ab2/editdata.dart';
  ...
  Future _getdata() async {
    try {
      final response = await http.get(
          Uri.parse("http://192.168.100.10/simple_api-main/conn.php"),
  ...
  Future _deletedata(String id) async {
    try {
      final response = await http.post(
          Uri.parse("http://192.168.100.10/simple_api-main/delete.php"),
          body: {"nisn": id},
          headers: {"Access-Control-Allow-Origin": "*"});
      if (response.statusCode == 200) {
        return true;
